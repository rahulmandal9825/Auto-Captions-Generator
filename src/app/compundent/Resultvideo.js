...
import { transcriptionItemsToSrt } from "./cleartranscriptionItems";
...
export default function ResultVideo({filename,transcriptionItems}) {
  const videoUrl = "https://rahul-auto-caption.s3.amazonaws.com/" + filename;
  ...
  return (
    ...
    <div className="flex gap-1">
      ...
      <div className="rounded-xl overflow-hidden relative w-[350px]">
        {progress && progress < 1 && (
